...
| ------ | ---------------- | ------------------- | ------- | ------------ |
| **薪资** | ~~$7550~~ $2000* | 25亿 QUBIC | $9550** | 119.4亿 QUBIC |
...
> [!IMPORTANT]
> 我们采用基于价格分层的**动态薪酬模型**。该三层薪酬系统会根据 Qubic 价格进行调整（可修改）。如果价格低于设定阈值，薪资将相应降低；若价格回升，则恢复至较高水平。该模型使薪酬与市场表现保持一致，在市场下行时帮助控制预算，在增长时提供激励。该模型已在实践中应用，使社区团队无需紧急预算调整即可持续运营。<br/><br/>月度薪资支出已从 **16,000 美元** 降至 **11,000 美元**；在当前 PA 条件下约减少 **30%**。截至 3 月，由于部分版主从全职转为兼职，且社区负责人尚未正式上任，目前月薪支出为 **7550 美元**。

> [!IMPORTANT] <br/>在过去一年中，我们定期举办每周社区活动。服务器约有 60,000 名成员，其中约 0.03%-0.17% 参与活动。活动包括每周游戏之夜、问答之夜，以及围绕项目大型事件的特别活动。目前活动及相关预算已暂停。<br/><br/>社区团队将暂停活动以进行调整。一些仅试图利用项目而未作出贡献的恶意行为已被发现。我们非常重视真实的支持和参与，此次暂停将有助于筛选此类行为。我们计划在今年晚些时候恢复活动，并欢迎新的想法和活动形式。
